...
```mermaid
flowchart TD
    L1["<b>Layer 1</b> — Stealth Browser<br/><i>usually sufficient</i>"]
    Q1{"Still blocked?"}
    L2["<b>Layer 2</b> — Humanizer<br/><i>(for interactions)</i>"]
    Q2{"IP-blocked?"}
    L3["<b>Layer 3</b> — Upstream Proxies"]
    Q3{"HTTP-only client<br/>TLS-blocked?"}
    L4["<b>Layer 4</b> — TLS Spoofing"]
    Q4{"Specific request<br/>issues?"}
    L5["<b>Layer 5</b> — Request Rules"]
    L1 --> Q1
    Q1 -- yes --> L2 --> Q2
    Q2 -- yes --> L3 --> Q3
    Q3 -- yes --> L4 --> Q4
    Q4 -- yes --> L5
    style L1 fill:#1f5a3d,color:#fff
    style L2 fill:#1f5a3d,color:#fff
    style L3 fill:#fbbf24,color:#000
    style L4 fill:#fbbf24,color:#000
    style L5 fill:#4d1f1f,color:#fff
```
