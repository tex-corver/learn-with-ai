...
flowchart LR
    ...
    R --> S[src/]
    S --> S1["main.ts<br/><i>Main source file</i>"]
    R --> ST[storage/]
    ST --> ST1[datasets/]
    ST --> ST2[key_value_stores/]
    ST --> ST3[request_queues/]
    R --> D["<b>config files</b><br/>.dockerignore<br/>.gitignore<br/>.prettierrc"]
    R --> DF["Dockerfile<br/><i>Build config</i>"]
    R --> EL["eslint.config.js<br/><i>Linting rules</i>"]
    R --> PK["package.json<br/><i>Dependencies</i>"]
